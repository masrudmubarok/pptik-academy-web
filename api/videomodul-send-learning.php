<?php
 ...
 $id_kursus = $_POST['id_kursus'];
  ...
  $query = "SELECT * FROM siswa, ambil_kursus, kursus, tutor WHERE siswa.id_siswa = ambil_kursus.id_siswa AND ambil_kursus.id_kursus = kursus.id_kursus AND kursus.id_tutor = tutor.id_tutor AND kursus.id_kursus='$id_kursus' ";
