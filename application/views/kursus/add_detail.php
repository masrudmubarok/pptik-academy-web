<div class="py-1">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <!-- <h3 class="display-3">Tambah Detail Kursus</h3> -->
            </div>
        </div>
    </div>
</div>
...
<div class="py-4">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <form id="c_form-h" method="post" action="<?= base_url('Kursus/create2'); ?>" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <select name="id_kursus" class="custom-select">
                                ...
                                <?php
                                foreach ($kkrs_list as $kkrs) {
                                    echo "<option value='$kkrs->id_kursus'>$kkrs->nama_kursus</option>";
                                }
                                ?>
                            </select>
                        </div>
